<%@ Page language="c#" Inherits="Faga.Framework.Services.Administracion.Dialogs.SeleccionarGrupo" CodeFile="SeleccionarGrupo.aspx.cs" %>
...
<form id="Form1" method="post" runat="server">
  <table class="window" width="100%" height="100%">
    ...
    <tr>
      <td>
        <asp:label id="lblAtributo" runat="server" cssclass="label">Grupo</asp:label>
      </td>
      <td>
        <asp:dropdownlist id="cboGrupo" runat="server" width="200px" cssclass="box"></asp:dropdownlist>
      </td>
    </tr>
    </tbody>
    <tfoot>
