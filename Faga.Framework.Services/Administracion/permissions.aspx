<%@ Page Language="c#" Inherits="Faga.Framework.Services.Administracion.Webpages.PermissionsPage"
CodeFile="Permissions.aspx.cs" %>
          ...
          <tr>
            <td>
              <table width="100%">
                ...
                <tr>
                  <th>
                    <asp:Label ID="lblTitle" runat="server" CssClass="label">Permisos</asp:Label>
                  </th>
                </tr>
                </thead>
                <tbody>
                          ...
                          <table>
                            ...
                            <tr>
                              <td style="height: 15px" align="right">
                                <asp:Label ID="lblName" runat="server" CssClass="label">Descripción</asp:Label>
                              </td>
                              <td style="height: 15px" align="left">
                                <asp:TextBox ID="txtDescription" runat="server" CssClass="box" Width="240px"></asp:TextBox>
                              </td>
                            </tr>
                          </table>
                        </td>
